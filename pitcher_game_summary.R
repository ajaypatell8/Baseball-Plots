...
pitcher_summary <- function (player_first_name, player_last_name, Date) {
  ...
  summary <- baseballr::fg_pitcher_game_logs(playerid = player_id_df$key_fangraphs, year = 2023) %>%
    filter(Date == unique(player$game_date)) 
...
pitcher_summary("Clarke", "Schmidt", "2023-04-18")
